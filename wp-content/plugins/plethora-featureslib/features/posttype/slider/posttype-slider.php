	...
	*/
	public function slide_options() {
	  ...
	  $slide_options['caption-title'] = array(
		  ...
		  'type'        => 'text',
		  'title'       => esc_html__( 'Caption Title', 'plethora-framework' ),
	  ...
	  $slide_options['caption-subtitle'] = array(
			...
			'type'        => 'text',
			'title'       => esc_html__( 'Caption Subtitle', 'plethora-framework' ),
	  ...
	  $slide_options['caption-secondarytext-mobile-display'] = array(
			'id'      => 'slide_caption_secondarytext_mobile_display',
			'type'    => 'select',
			'title'   => esc_html__( 'Additional Caption Text Mobile View Display', 'plethora-framework'),
			'options' => array(
				'foo'        => esc_html__( 'Displayed on mobile view', 'plethora-framework' ) ,
				'hidden-xxs' => esc_html__( 'Not displayed on mobile view', 'plethora-framework' )
			),
	  );
		...
		foreach ($slider['slide_image'] as $key => $slide ) {
		 if ( !empty($slide) ) {
			...
			if ( $status && isset( $fullimg[0] ) && !empty( $fullimg[0] ) ) {
				...
				$slide['caption_secondarytext_mobile_display'] = !empty( $slider['slide_caption_secondarytext_mobile_display'][$key] ) ? esc_attr( $slider['slide_caption_secondarytext_mobile_display'][$key] ) : 'hidden-xxs';
