      ...
      function theme_options_tab( $sections ) {
        ...
        'fields'     => array(
          ...
          // MAILCHIMP API SETTINGS
            ...
            array(
              'id'       => THEMEOPTION_PREFIX .'mailchimp_optin',
              'type'     => 'switch',
              'on'       => esc_html__( 'Enabled', 'plethora-framework' ),
              'off'      => esc_html__( 'Disabled', 'plethora-framework' ),
              'title'    => esc_html__('Enable Email optin', 'plethora-framework'),
              'subtitle' => esc_html__('By enabling this option, MailChimp will send a confirmation email to the user before the subscription process.', 'plethora-framework'),
              'default'  => ''
              ),
            /*
            array(
