       ...
       */
       public function content( $atts, $content = null ) {
          ...
          extract( shortcode_atts( array( 
            ...
            "email_placeholder"       => esc_html__( 'Email Address', 'plethora-framework' ),
            "button_text"             => esc_html__( 'SUBSCRIBE', 'plethora-framework' ),
            "svg_newsletter"          => '0',
            "svg_newsletter_image"    => "",
            "svg_newsletter_title"    => esc_html__( 'OUR NEWSLETTER', 'plethora-framework' ),
            "svg_newsletter_subtitle" => esc_html__( 'Subscribe and get daily notifications about our offers', 'plethora-framework' ),
            /*** ENABLE FIRST NAME - SURNAME INPUT FIELDS [2] ***/
            "name_inputbox"           => '0',
            "firstname_placeholder"   => esc_html__( 'First Name', 'plethora-framework' ),
            "lastname_placeholder"    => esc_html__( 'Last Name', 'plethora-framework' ),
            /*** /ENABLE FIRST NAME - SURNAME INPUT FIELDS [2] ***/
      ...
      public function ajax_handler() {
        ...
        $lastname          = isset( $_POST["surname"] ) ? sanitize_text_field( $_POST["surname"] ) : "";
         ...
         if ( is_email( $email ) === false ) {
          ...
          $mailchimp_apikey = '';
          $mailchimp_listid = '';
          $mailchimp_optin  = false;

          if ( method_exists('Plethora_Theme', 'option') ) {

            $mailchimp_apikey = Plethora::option( METAOPTION_PREFIX . 'mailchimp_apikey');
            $mailchimp_listid = Plethora::option( METAOPTION_PREFIX . 'mailchimp_listid');
            $mailchimp_optin  = Plethora::option( METAOPTION_PREFIX . 'mailchimp_optin');
          ...
          if ( 
            ...
            $mailchimp_optin = $mailchimp_optin ? true : false;

            $mailchimp_data = array(
              'id'                => $mailchimp_listid,
              'email'             => array( 'email'=> $_POST['email'] ),
              'double_optin'      => $mailchimp_optin,
