...
class Mustache_Cache_FilesystemCache extends Mustache_Cache_AbstractCache
{
    ...
    // PLEFIXME: Not necessary for production, so it was removed temporarily in order to comply with WP restrictions.
...
class Mustache_Loader_InlineLoader implements Mustache_Loader
{
    ...
    protected function loadTemplates()
    {
        if ($this->templates === null) {
            ...
            // PLEFIXME: Updated in order to comply with WP restrictions.
            global $wp_filesystem;
            $data = $wp_filesystem->get_contents($this->fileName);
...
class Mustache_Parser
{
    ...
    {
        if ( !is_null( $parent ) && $parent[Mustache_Tokenizer::TYPE] === Mustache_Tokenizer::T_PARENT) {
