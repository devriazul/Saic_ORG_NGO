                ...
                if ( $pagenow == "post-new.php" || $pagenow == "post.php" ) {
                    ...
                    if ( in_array( $post->post_type, $types ) ) {
                        ...
                        wp_enqueue_style(
                            ...
                            apply_filters( "redux/metaboxes/{$this->parent->args['opt_name']}/enqueue/redux-extension-metaboxes-css", $this->extension_url . 'extension_metaboxes.css' ),
                            array(),
                            self::$version,
                            'all'
                        );
                        ...
                        wp_enqueue_script(
                            ...
                            apply_filters( "redux/metaboxes/{$this->parent->args['opt_name']}/enqueue/redux-extension-metaboxes-js", $this->extension_url . 'extension_metaboxes' . Redux_Functions::isMin() . '.js' ),
