    ...
    if ( ! class_exists( 'ReduxFramework_repeater' ) ) {
        ...
        class ReduxFramework_repeater {
            ...
            public function __construct( $field = array(), $value = '', $parent ) {
                ...
                $this->field['bind_title_custom'] = false;
                if ( is_array( $this->field['bind_title'] ) ) {

                    $key                              = key( $this->field['bind_title'] );
                    $val                              = $this->field['bind_title'][$key];
                    $this->field['bind_title']        = $key;
                    $this->field['bind_title_custom'] = $val;
                }
                            ...
                            foreach ( $this->field['fields'] as $field ) {
                                if ( $field['id'] == $this->field['bind_title'] ) {
                                    ...
                                    if ( isset( $field['options'] ) && is_array( $field['options'] ) && ! empty( $field['options'] ) ) {
                                     ...
                                     if ( !empty( $this->field['bind_title_custom'] ) ) {

                                         $repeater['title'] = isset( $this->parent->options[ $this->field['id'] ][ $field['id'] ][ $x ][$this->field['bind_title_custom']] ) ? $this->parent->options[ $this->field['id'] ][ $field['id'] ][ $x ][$this->field['bind_title_custom']] : $default;
                                     }
                               }
                            }
                            ...
                            if ( isset( $this->field['bind_title'] ) && $field['id'] == $this->field['bind_title'] ) {
                                if ( ! isset( $field['class'] ) || ( isset( $field['title'] ) && empty( $field['title'] ) ) ) {
                                    ...
                                    if ( !empty( $this->field['bind_title_custom'] ) ) {
                                        ...
                                        $field[ $this->field['bind_title_custom'] .'_class'] = "bind_title";
