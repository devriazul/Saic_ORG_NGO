    ...
    redux.field_objects.repeater.sort_repeaters = function( selector ) {
        ...
        selector.find( '.redux-repeater-accordion-repeater' ).each(
            function( idx ) {
                ...
                // PLEFIXME: Added special treatment for problematic textarea field sortings ( apply on min version too )
                ...
                var accordian = el.find( ".redux-repeater-accordion" ).accordion(
                    {
                        ...
                        collapsible: true,
                        // PLEFIXME: Remove comment from the following row ( setting 'active' to false will collapse all panels by default )
                        active: false,
                    ...
                    accordian.sortable(
                        {
                            axis: "y",
                            handle: "h3",
                            // PLEFIXME: Remove connectWith to avoid drag 'n drop nesting selections to neighbor repeater fields
