...
<div class="col-md-12">
	<article id="post-nopost" <?php post_class('post'); ?>>
	     <div class="post_header">
	          <h2 class="post_title">
	              <?php echo wp_kses( $blog_noposts_title, Plethora_Theme::allowed_html_for( 'heading' ) ) ; ?>
	          </h2>
	     </div>
	     <div class="post_content">
	          <p><?php echo wp_kses( $blog_noposts_description, Plethora_Theme::allowed_html_for( 'paragraph' ) ) ; ?></p>
	     </div>
	</article>
</div>
