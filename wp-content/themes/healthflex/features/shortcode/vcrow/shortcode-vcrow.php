       ...
       public function params() {
          ...
          $params =  array(
                    ...
                    array(
                        ...
                        "value"         => array(
                                              esc_html__('Default', 'healthflex')     =>'',
                                              esc_html__('Left', 'healthflex')     =>'text-left',
                                              esc_html__('Centered', 'healthflex') => 'text-center',
                                              esc_html__('Right', 'healthflex')    => 'text-right',
                                              esc_html__('Justify', 'healthflex')  => 'text-justify',
                          ),
                        "admin_label"   => false,
                    ),
                    ...
                    array(
                        ...
                        "value"         => array(
                                                esc_html__('No', 'healthflex')  => 0,
                                                esc_html__('Yes', 'healthflex') => 1,
                                            ),
                    ...
                    array(
                        ...
                        "value"         => array(
                                                esc_html__('Vertical Top', 'healthflex') => 'full_height',
                                                esc_html__('Vertical Center', 'healthflex') => 'full_height vertical_center',
                                                esc_html__('Vertical Bottom', 'healthflex') => 'full_height vertical_bottom',
                                            ),
                        "admin_label"   => false,
                        "dependency"    => array(
                                                "element" => "full_height",
                    ...
                    array(
                        ...
                        "value"         => array(
                                                esc_html__('Default padding', 'healthflex') => '',
                                                esc_html__('No padding', 'healthflex') => 'no_padding',
                                                esc_html__('No top padding', 'healthflex') => 'no_top_padding',
                                                esc_html__('No bottom padding', 'healthflex') => 'no_bottom_padding',
                                            ),
                    ...
                    array(
                        ...
                        "value"         => array(
                                                esc_html__('Align columns to their vertical top', 'healthflex') => '',
                                                esc_html__('Align columns to their vertical centers', 'healthflex') => 'vcenter',
                                                esc_html__('Align columns to their vertical bottom', 'healthflex') => 'vbottom',
                                            ),
                        "admin_label"   => false,
                    ),
                     array(
                        ...
                        "value"         => array(
                                                esc_html__('Yes', 'healthflex') => '',
                                                esc_html__('No', 'healthflex') => 'no_cols_padding',
                                            ),
                    ...
                    array(
                        ...
                        "value"         => array(
                                                esc_html__('No', 'healthflex') => '',
                                                esc_html__('Angled Positive', 'healthflex') => 'separator_top sep_angled_positive_top',
                                                esc_html__('Angled Negative', 'healthflex') => 'separator_top sep_angled_negative_top',
                                            ),
                    ...
                    array(
                        ...
                        "value"         => array(
                                                esc_html__('No', 'healthflex') => '',
                                                esc_html__('Angled Positive', 'healthflex') => 'separator_bottom sep_angled_positive_bottom',
                                                esc_html__('Angled Negative', 'healthflex') => 'separator_bottom sep_angled_negative_bottom',
                                            ),
                    ...
                    array(
                        ...
                        "value"         => array(
                                              esc_html__('Solid Color Set Background ( requires a color set selection above )', 'healthflex') => 'color',
                                              // esc_html__('Gradient Angled Background ( primary/secondary colors )', 'healthflex') => 'gradient',
                                              esc_html__('Image', 'healthflex') => 'bgimage',
                                              esc_html__('Video', 'healthflex') => 'video',
