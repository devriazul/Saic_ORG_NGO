	...
	class Plethora_Module_Topbar {
	    ...
	    public static function top_bar() {
	      ...
	      if ( $top_bar ) {
	        ...
	        $module_atts = apply_filters( 'plethora_module_topbar_atts', $module_atts );
	    ...
	    *
	    */
	    static function metabox_header_options( $section_fields ) {

	    	// Always hook on $section['metabox_header_elements']['fields'] array key
			$section_fields = array_merge( $section_fields, array(
