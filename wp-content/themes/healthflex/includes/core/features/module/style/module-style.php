		...
		public static function get_index_values( $type ) {
			...
			switch ( $type ) {
				...
				case 'image_sizes':
					...
					$return = array( 
                          	'thumbnail' 	=> array( 
								'title'     => esc_html__( 'Thumbnail', 'plethora-framework' ),
								'title_alt' => esc_html__( 'Thumbnail', 'plethora-framework' ),
								'value'     => 'thumbnail',
							),
                          	'medium' 	=> array( 
								'title'     => esc_html__( 'Medium', 'plethora-framework' ),
								'title_alt' => esc_html__( 'Medium', 'plethora-framework' ),
								'value'     => 'medium',
							),
                          	'large' 	=> array( 
								'title'     => esc_html__( 'Large', 'plethora-framework' ),
								'title_alt' => esc_html__( 'Large', 'plethora-framework' ),
								'value'     => 'large',
							),
                          	'full' 	=> array( 
								'title'     => esc_html__( 'Full ( original image size, use with caution )', 'plethora-framework' ),
								'title_alt' => esc_html__( 'Full ( original image size, use with caution )', 'plethora-framework' ),
								'value'     => 'full',
							),
                      	);
					break;
