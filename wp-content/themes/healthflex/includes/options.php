...
if ( !class_exists( 'Plethora_Themeoptions' ) ):
	...
	class Plethora_Themeoptions {
		...
		public function __construct() {
			...
			// Redux 4.1.15 Update : remove connection banner
			add_action( 'admin_init', array( $this, 'remove_redux_banner' ), 9999999 );
			add_action( 'admin_menu', array( $this, 'remove_menu_page' ), 99999 );
		}
		...
		public function remove_redux_banner() {

			if ( class_exists( 'Redux_Connection_Banner' ) ) {

				$banner_obj = Redux_Connection_Banner::init();
				remove_action( 'current_screen', array( $banner_obj, 'maybe_initialize_hooks' ) );
			}
		}
		...
		public function setArguments() {
	        ...
	        $args['output_tag'] 		= false;                     // Allows dynamic CSS to be generated for customizer and google fonts, but stops the dynamic CSS from going to the head
	    	...
	    	$sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle'   => esc_html__('Enable Subtitle text left to right animation', 'healthflex'),
						"default" => 0,
					),
			...
			$sections[] = array(
				...
				'fields'     => array_merge(
									array(
										...
										// Custom Body Class
									    array(
											'id'          => METAOPTION_PREFIX .'custombodyclass',
											'type'        => 'text',
											'title'       => esc_html__('Custom Body Class', 'plethora-framework'),
											'description'    => esc_html__('Paste your custom classes separated by single space.', 'plethora-framework'),
											'default'     => '',
											'validate' => 'no_html'
										)
	    ...
	    function subsection_headermain( $sections ) {
	    	...
	    	$sections[] = array(
				...
				'fields'     => array(
						...
						array(
							'id'      => METAOPTION_PREFIX .'header-sticky-topbar',
							'type'    => 'switch',
							'title'   => esc_html__('Sticky Top Bar On Scroll', 'healthflex'),
							'desc'   => esc_html__('Set it to ON if you want your Top Bar also to remain on top along with the header.', 'healthflex'),
							"default" => 0,
						),
	    	...
	    	$sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'default'   => esc_html__('Copyright &copy;2017 all rights reserved', 'healthflex'),
						'translate' => true,
						),
					array(
	   ...
	   */
		public static function metabox_header_elements( $sections ) {
		    ...
		    $sections[] = array(
		        ...
		        'icon'          => 'el-icon-circle-arrow-up',
		        'fields'        => apply_filters( 'plethora_themeoptions_metabox_header_elements', array(
...
//// LESS CONFIGURATION BEGINS
		public static function less_variables( $vars ) {
			...
			// Color Sets > Basic
			$vars['wp-brand-primary']    = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-brand-primary', '#4EABF9' );
			$vars['wp-brand-secondary']  = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-brand-secondary', '#304770' );
			$vars['wp-body-bg']          = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-body-bg', '#EFEFEF' );
			$vars['wp-text-color']       = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-text-color', '#323232' );
			$vars['wp-link-color']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-link-color', 'regular', '#4EABF9' );
			$vars['wp-link-hover-color'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-link-color', 'hover', '#2885D3' );

			// Color Sets > Primary
			$vars['wp-skin-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-skin-section-txtcolor', '#ffffff' );
			$vars['wp-skin-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-skin-section-linkcolor', 'regular', '#F8EB80' );
			$vars['wp-skin-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-skin-section-linkcolor', 'hover', '#B2B300' );
			...
			$vars['wp-secondary-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-secondary-section-linkcolor', 'regular', '#F8EB80' );
			$vars['wp-secondary-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-secondary-section-linkcolor', 'hover', '#B2B300' );

			// Color Sets > Light
			$vars['wp-light-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-light-section-bgcolor', '#aaaaaa' );
			$vars['wp-light-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-light-section-txtcolor', '#323232' );
			$vars['wp-light-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-light-section-linkcolor', 'regular', '#1c92b9' );
			$vars['wp-light-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-light-section-linkcolor', 'hover', '#006C93' );

			// Color Sets > Dark
			$vars['wp-dark-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-dark-section-bgcolor', '#222D3F' );
			$vars['wp-dark-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-dark-section-txtcolor', '#ffffff' );
			$vars['wp-dark-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-dark-section-linkcolor', 'regular', '#FF6B10' );
			$vars['wp-dark-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-dark-section-linkcolor', 'hover', '#D94500' );
			...
			$vars['wp-white-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-white-section-linkcolor', 'regular', '#4EABF9' );
			$vars['wp-white-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-white-section-linkcolor', 'hover', '#006C93' );

			// Color Sets > Black
			$vars['wp-black-section-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-black-section-bgcolor', '#151515' );
			$vars['wp-black-section-txtcolor']        = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-black-section-txtcolor', '#ffffff' );
			$vars['wp-black-section-linkcolor']       = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-black-section-linkcolor', 'regular', '#FF6B10' );
			$vars['wp-black-section-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-black-section-linkcolor', 'hover', '#FFFFA6' );
			...
			// Misc > Media Panel
			$vars['wp-full-width-photo-min-panel-height']    = Plethora_Theme::option( METAOPTION_PREFIX .'mediapanel-less-full-width-photo-min-panel-height', '380', 0, false) .'px';
			...
			$vars['wp-header-bgcolor']         = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-header-bgcolor', '#304770' );
			...
			$vars['wp-header-linkcolor-hover'] = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-header-linkcolor', 'hover', '#4EABF9' );

			// Top Bar
			$vars['wp-topbar-bgcolor']                  = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-topbar-bgcolor', '#232323' );
			$vars['wp-topbar-txtcolor']                 = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-topbar-txtcolor', '#ffffff' );
			$vars['wp-topbar-linkcolor']                = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-topbar-linkcolor', 'regular', '#F8EB80' );
			$vars['wp-topbar-linkcolor-hover']          = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-topbar-linkcolor', 'hover', '#FCF6C9' );

			// Footer
			$vars['wp-footer-bgcolor']                  = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-footer-bgcolor', '#232323' );
			$vars['wp-footer-txtcolor']                 = Plethora_WP::get_hex_color_optionval( THEMEOPTION_PREFIX .'less-footer-txtcolor', '#ffffff' );
			$vars['wp-footer-linkcolor']                = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-footer-linkcolor', 'regular', '#F8EB80' );
			$vars['wp-footer-linkcolor-hover']          = Plethora_WP::get_hex_color_optionval_array( THEMEOPTION_PREFIX .'less-footer-linkcolor', 'hover', '#FCF6C9' );
